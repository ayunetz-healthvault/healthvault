...
export const MOCK_SUMMARIES: DocumentSummary[] = [
  {
    ...
    findings: [
      {
        ...
        sources: [
          { documentId: 'doc_demo_hba1c', page: 1, textSnippet: 'HbA1c 8.1 % (ref: < 7.0 %)' },
        ],
      },
      {
        id: 'fnd_demo_2',
        ...
        sources: [
          { documentId: 'doc_demo_hba1c', page: 1, textSnippet: 'Glucose, fasting 142 mg/dL' },
        ],
      },
      {
        id: 'fnd_demo_3',
        ...
        sources: [{ documentId: 'doc_demo_hba1c', page: 2 }],
      },
      {
        id: 'fnd_demo_4',
    ...
    medicines: [
      {
        ...
        duration: 'Continuing',
        sources: [{ documentId: 'doc_demo_hba1c', page: 1 }],
      },
      {
        id: 'med_demo_2',
        name: 'Glimepiride',
    ...
    explicitFollowUps: [
      {
        ...
        source: {
          documentId: 'doc_demo_hba1c',
          page: 2,
          textSnippet: 'Suggest repeat HbA1c after 3 months',
        },
        confidence: 0.86,
      },
    ],
    uncertainties: [
      {
        message: 'The thyroid panel at the foot of page 2 was cut off and has not been included.',
        sourcePage: 2,
      },
    ],
    privacy: {
  ...
  },
  {
    ...
    medicines: [
      ...
      },
      {
        ...
        duration: '14 days',
        sources: [{ documentId: 'doc_demo_knee', page: 1 }],
      },
    ],
    instructions: [
    ...
    detectedDocumentDate: '2026-03-22',
    explicitFollowUps: [
      {
        title: 'Follow-up X-ray of the right knee',
        date: '2026-09-22',
        kind: 'doctor_visit',
        source: {
          documentId: 'doc_demo_knee',
          page: 1,
          textSnippet: 'Review X-ray right knee at 6 months',
        },
        confidence: 0.9,
      },
      {
        title: 'Physiotherapy, twice a week',
        // The document gives a course, not a single date.
        date: null,
        kind: 'physiotherapy',
        source: {
          documentId: 'doc_demo_knee',
          page: 1,
          textSnippet: 'Physiotherapy 2x/week for 12 weeks',
        },
        confidence: 0.82,
      },
    ],
